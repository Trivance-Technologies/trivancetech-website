export const bodyHeaderDataMap: Record<string, {
    title: string;
    subTitle: string;
    description: string;
    link: string;
    ...
    "/products": {
        title: "Products",
        subTitle: "Explore our innovative products designed to enhance your business growth",
        description: "Discover cutting-edge solutions that streamline operations, boost efficiency, and drive success.",
        link: "/about",
